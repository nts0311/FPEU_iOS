...
public struct SheetOptions {//swiftlint:disable identifier_name
    ...
    @available(*, deprecated, message: "minimumSpaceAbovePullBar is now a property on VDSBottomSheetVC")
    ...
    @available(*, deprecated, message: "gripSize is now a property on VDSBottomSheetVC")
    public var gripSize: CGSize {
        get { return _gripSize }
        set { _gripSize = newValue }
    }
    var _gripSize = CGSize(width: Sizing.tokenSizing48, height: Sizing.tokenSizing04)
    
    @available(*, deprecated, message: "gripColor is now a property on VDSBottomSheetVC")
    ...
    @available(*, deprecated, message: "pullBarBackgroundColor is now a property on VDSBottomSheetVC")
    ...
    @available(*, deprecated, message: "cornerRadius is now a property on VDSBottomSheetVC")
    ...
    @available(*, deprecated, message: "cornerRadius, minimumSpaceAbovePullBar, gripSize and gripColor are now properties on VDSBottomSheetVC. Use them instead.")
    public init(pullBarHeight: CGFloat? = nil,
                gripSize: CGSize? = nil,
